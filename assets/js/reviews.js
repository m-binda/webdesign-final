...
document.getElementById("button-review-articles").style.backgroundColor = "#002f4932";
...
videosButton.addEventListener("click", function () {
    ...
    document.getElementById("button-review-videos").style.backgroundColor = "#002f4932";
});